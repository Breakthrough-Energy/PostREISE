...
scenarios_total = {'x1':['PG.pkl',None],
                   'x2':['PG_RenX2.pkl',None],
                   'x3':['PG_RenX3.pkl',None],
                   'x4':['PG_RenX4.pkl',None]}
...
def scenarios_onezone(zone):
    """Plots the power generated by each resource in a given zone with respect to the total
       power generated in that zone for various scenarios.

    Arguments:
        zone: either total or California

    Returns:
        Power generated allotment per resource type
    """
    if zone == 'total':
        scenarios = scenarios_total
    elif zone == 'California':
